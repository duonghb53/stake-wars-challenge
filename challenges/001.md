...
### Create a wallet
Go to https://wallet.shardnet.near.org/ and create a wallet
...
node -v
```
![Node Version](https://github.com/duonghb53/stake-wars-challenge/blob/master/images/node_version.png)

```
npm -v
```
![NPM Version](https://github.com/duonghb53/stake-wars-challenge/blob/master/images/npm_version.png)
...
near proposals
```
![proposals](https://github.com/duonghb53/stake-wars-challenge/blob/master/images/proposals.png)
...
```
![validators current](https://github.com/duonghb53/stake-wars-challenge/blob/master/images/current_validators.png)
...
```
![validators next](https://github.com/duonghb53/stake-wars-challenge/blob/master/images/next_validators.png)
